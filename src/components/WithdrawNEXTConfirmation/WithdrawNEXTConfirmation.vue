<template>
    <div class="withdraw-next-confirmation">
        <tx-confirmation
            :tx="tx"
            confirmation-comp-name="withdraw-next-confirmation"
            send-button-label="Withdraw"
            password-label="Please enter your wallet password to withdraw your NEXT"
        ...
        >
            <h2 class="not-visible" data-focus>Withdraw delegated NEXT - Confirmation</h2>
...
export default {
    ...
    props: {
        ...
        /** Amount of NEXT tokens to withdraw */
        amount: {
            type: Number,
            default: 1,
        },
    ...
    methods: {
        ...
        onSendTransactionSuccess(_data) {
            this.$emit('change-component', {
                to: 'staking-withdraw-next-confirmation-success-message',
                from: 'withdraw-next-confirmation',
                data: {
