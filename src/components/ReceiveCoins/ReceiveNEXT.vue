<template>
    <div class="receive-next">
            ...
            <h3 class="address break-word" :class="addressCssClass">
                ...
                >
                    <template #popover-text>
                        ...
                        Warning: Use this address to receive NEXT only. If you are receiving NEXT-ERC20 you need to use
                        a different address!
                    </template>
                </f-copy-button>
        ...
        >
            ...
            <div class="align-center">
                <img src="img/nano-s-verify-address.png" alt="next nano device" /><br /><br />
            </div>
