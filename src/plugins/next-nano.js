// Basic functions for communication with next nano ledger hw, using next-ledgerjs

import NextNano from 'next-ledgerjs/src/next-nano.js';
...
export class FNano {
    ...
    async getVersion() {
        ...
        if (transport) {
            ...
            const bridge = new NextNano(transport);
