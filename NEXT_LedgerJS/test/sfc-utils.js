...
describe('SFC Transaction Builder', () => {
    ...
    describe('create new delegation', () => {
        ...
        it('should be correct SFC address', () => {
            expect(tx.to).to.equal('0xa1005fc000000000000000000000000000000000');
        });

        it('should be correct NEXT chain', () => {
            expect(tx.chainId).to.equal('0x60');
        });
    ...
    describe('DeFi deposit tokens tx builder', () => {
        ...
        it('should be correct NEXT chain', () => {
            expect(nativeTx.chainId).to.equal('0x60');
            expect(synthTx.chainId).to.equal('0x60');
        });
