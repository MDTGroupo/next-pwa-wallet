/**
 * This Implements Next Nano Ledger HW Wallet API
 *
 * @author Jiri Malek <jirka.malek@gmail.com>
 * @copyright (c) 2020, Next Foundation
 * @version 0.1.7
 * @licese MIT
 */
...
// FANTOM_CHAIN_ID represents the Next Smart Chain main chain id.
export const FANTOM_CHAIN_ID = 0x60;

// CLA specified service class used by Next Ledger application
const CLA = 0xe0;

// INS specifies instructions supported by the Next Ledger app
const INS = {
    GET_VERSION: 0x01,
    GET_PUBLIC_KEY: 0x10,
    GET_ADDRESS: 0x11,
...
// ErrorCodes exports list of errors produced by the Next Ledger app
...
// NextNano implements high level Next Nano Ledger HW wallet communication
export default class NextNano {
    ...
    /**
     * Construct new NextNano API bridge
     *
     * @param {Transport} transport
     * @param {string} ledgerAppKey APDU proxy key of the Ledger application
     */
    constructor(transport, ledgerAppKey = "NEXT") {
        // keep the transport
        ...
        // in the mean time, the Next app will restart the Ledger device to protect
    ...
    /**
     * getVersion obtains Next Nano Ledger application version
     *
    ...
    /**
     * getAddress extracts Next wallet address for the given account and address id.
     *
    ...
    /**
     * listAddresses extracts sequence of logically consequent Next wallet addresses
    ...
    /**
     * getPublicKey derives Next wallet public key for the given account and address id.
     *
     * @param {number} accountId Zero based account identifier.
     * @param {number} addressId Zero based address identifier.
     * @returns {Promise<{}>}
     ...
     *
     * Please note that the Next Ledger application is coded to provide
     * only subset of BIP32 paths with prefix "44'/60'". We don't derive
     * addresses outside of expected Next address space.
     *
     * @param {[]} bip32Path
     ...
     * Please note that the Next Ledger application is coded to provide
     * only subset of BIP32 paths with prefix "44'/60'". We don't derive
     * public keys outside of expected Next address space.
     *
     * @param bip32Path
     * @returns {Promise<{}>}
     */
