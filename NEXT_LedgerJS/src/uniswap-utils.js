 ...
 * by an array of token addresses. If you want to use native NEXT token
 * on the input, or output, use Wrapped NEXT token address instead.
 *
 * @param {Web3} web3
 * @param {string} routerAddress
...
/**
 * uniswapAddLiquidityNEXT creates a contract call transaction to add liquidity
 ...
 * @param {string|{BN}} amountNEXTDesired
 * @param {string|{BN}} amountTokenMin
 * @param {string|{BN}} amountNEXTMin
 * @param {string} to
 * @param {string|{BN}} deadline
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapAddLiquidityNEXT(
    web3,
    routerAddress,
    token,
    amountTokenDesired,
    ...
    return {
        to: routerAddress,
        value: web3Utils.numberToHex(amountNEXTDesired),
        data: web3.eth.abi.encodeFunctionCall({
            "constant": false,
            "inputs": [
                {
            ...
            "type": "function"
        }, [token, amountTokenDesired, amountTokenMin, amountNEXTMin, to, deadline])
    };
}
...
/**
 * uniswapRemoveLiquidityNEXT creates a contract call transaction to remove liquidity
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapRemoveLiquidityNEXT(
    web3,
    routerAddress,
    token,
    liquidity,
    ...
    return {
        ...
        data: web3.eth.abi.encodeFunctionCall({
            ...
            "stateMutability": "nonpayable",
            "type": "function"
        }, [token, liquidity, amountTokenMin, amountNEXTMin, to, deadline])
    };
}
...
/**
 * uniswapExactNEXTForTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the Wrapped Native NEXT one and the last token is the exit one.
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactNEXTForTokens(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
/**
 * uniswapNEXTForExactTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the Wrapped Native NEXT and the last token is the exit one.
 * The output amount is exact and the input amount is specified by maximal allowed
 * quantity. Fuzziness of the call is towards the input. Native NEXT tokens
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapNEXTForExactTokens(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapTokensForExactNEXT creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the entry one and the last token is the Wrapped NEXT. The output
 * amount is exact and the input amount is specified by maximal allowed quantity.
 * Fuzziness of the call is towards the input. Sufficient allowance is required
 * on input token to cover the max amount offered. Native NEXT is returned on success.
 *
 * @param {Web3} web3
 * @param {string} routerAddress
 * @param {string|{BN}} amountOut
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapTokensForExactNEXT(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapExactTokensForNEXT creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the entry one and the last token is the Wrapped NEXT. The input
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactTokensForNEXT(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
export default {
    ...
    /*********** liquidity ***********/
    uniswapAddLiquidity,
    uniswapAddLiquidityNEXT,
    uniswapRemoveLiquidity,
    uniswapRemoveLiquidityNEXT,
    uniswapApproveShareTransfer,

    /*********** SWAP calls **********/
    uniswapExactTokensForTokens,
    uniswapExactNEXTForTokens,
    uniswapTokensForExactTokens,
    uniswapNEXTForExactTokens,
    uniswapTokensForExactNEXT,
    uniswapExactTokensForNEXT,
};
